// file: /lib/swagger/expense_batches/find-by-id-response-example.ts

import Joi from "joi";

const findExpenseBatchByIdResponseExample = {
  success: true,
  message: "Expense batch retrieved successfully",
  data: {
...
export const findExpenseBatchByIdResponseSchema = Joi.object({
...
}).example(findExpenseBatchByIdResponseExample);