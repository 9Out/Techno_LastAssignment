...
const deleteIncomeBatchResponseExample = {
  success: true,
  message: "Income batch deleted successfully",
  data: {
    ...
    deletedAt: "2025-12-07T16:53:40.687Z",
    deletedBy: "9f2c8c34-0c6f-4bd1-9b2c-4ddf6b5c59c1"
  }
};

export const deleteIncomeBatchResponseSchema = Joi.object({
...
}).example(deleteIncomeBatchResponseExample);