...
const findIncomeBatchByIdResponseExample = {
  success: true,
  message: "Income batch retrieved successfully",
  data: {
...
export const findIncomeBatchByIdResponseSchema = Joi.object({
...
}).example(findIncomeBatchByIdResponseExample);